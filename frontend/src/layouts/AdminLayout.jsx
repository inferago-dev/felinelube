...
export default function AdminLayout({ children, currentTab, setTab }) {
  const menuItems = [
        ...
        <header className="admin-topbar">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', borderLeft: '1px solid var(--admin-border)', paddingLeft: '1.5rem' }}>
              ...
              <div style={{ width: '36px', height: '36px', background: 'var(--admin-accent)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyCenter: 'center', fontWeight: '800', color: 'black' }}>
                AU
              </div>
            </div>
          </div>
